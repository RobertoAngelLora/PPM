#include <stdio.h>
// Prueba de parametrod por referencia
...
void f1(int *R)
/* La funcion f1 recibe un parametro por referencia. cada vez que el parametro se utiliza en la funcion de çbe ir
precedido por el operador de indereccion. */
